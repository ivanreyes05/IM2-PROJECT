...
databaseURL: "https://fir-project-81a06-default-rtdb.firebaseio.com",
...
document.addEventListener('DOMContentLoaded', () => {
    document.getElementById("submit").addEventListener('click', async function(e) {
        ...
        try {
            // Ensure the path is correct and that Firebase is properly initialized
            ...
            console.error("Error saving data:", error); // Log any saving errors
        }
    });
...
try {
    ...
    if (membersData) {
        ...
        for (const key in membersData) {
            ...
            if (member) { // Check if member is defined
                ws_data.push([
                    member.username || 'N/A',
                    member.email || 'N/A',
